  ...
  return (
    ...
    <div className="text-white flex flex-col gap-6 justify-center items-start">
      ...
      <h4 className='text-xl'>
        Upgrade to a curated expirence to access vetted and exclusive tools
      </h4>
      <ul className='flex flex-col gap-4'>
        <li className='flex gap-2 items-center'>
          <BsCheckCircle className='text-[#6264a] text-2xl' /> 
      ...
      <button className='border text-base font-medium px-5 py-2 border-[#1DBF73]
      bg-[#1DBF73] text-white rounded-md'
      type='button'>
